export default {
  lineList: [
    ...
    { name: '5号线', color: '#FF9900', stations: [ 70, 71, 72, 73, 74, 75, 76, 64, 77, 78, 79, 80, 81, 82, 33, 83, 84, 85, 12, 86, 87, 88, 89, 90, 91, 92, 93, 94 ] },
    { name: '6号线', color: '#E24BAF', stations: [ 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 87, 88, 89, 105, 106, 107, 53, 108, 109, 110, 111, 41, 112, 113, 20, 114, 115, 116, 117, 62, 118, 119, 80, 120, 121, 122, 123, 124 ] },
    { name: '9号线', color: '#024FA3', stations: [ 36, 125, 126, 85, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143 ] },
    { name: '导轨电车1号线', color: '#33CCCC', stations: [ 139, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156 ] }
  ],
  stationList: [
    ...
    { id: 94, name: '李七庄南', pinyin: 'liqizhuangnan', py: 'lqzn', lat: '39.034125', lng: '117.163934' },
    { id: 95, name: '梅林路', pinyin: 'meilinlu', py: 'mll', lat: '39.044823', lng: '117.254544' },
    { id: 96, name: '洞庭路', pinyin: 'dongtinglu', py: 'dtl', lat: '39.043598', lng: '117.245854' },
    { id: 97, name: '解放南路', pinyin: 'jiefangnanlu', py: 'jfnl', lat: '39.040765', lng: '117.233945' },
    { id: 98, name: '梅江会展中心', pinyin: 'meijianghuizhanzhongxin', py: 'mjhzzx', lat: '39.044382', lng: '117.217734' },
    { id: 99, name: '梅江公园', pinyin: 'meijianggongyuan', py: 'mjgy', lat: '39.052314', lng: '117.217551' },
    { id: 100, name: '左江道', pinyin: 'zuojiangdao', py: 'zjd', lat: '39.060029', lng: '117.217702' },
    { id: 101, name: '梅江道', pinyin: 'meijiangdao', py: 'mjd', lat: '39.06895', lng: '117.225619' },
    { id: 102, name: '黑牛城道', pinyin: 'heiniuchengdao', py: 'hncd', lat: '39.08002', lng: '117.224042' },
    { id: 103, name: '尖山路', pinyin: 'jianshanlu', py: 'jsl', lat: '39.087249', lng: '117.223999' },
    { id: 104, name: '乐园道', pinyin: 'leyuandao', py: 'lyd', lat: '39.091312', lng: '117.217498' },
    { id: 105, name: '水上公园东路', pinyin: 'shuishanggongyuandonglu', py: 'ssgydl', lat: '39.079495', lng: '117.172909' },
    { id: 106, name: '南翠屏', pinyin: 'nancuiping', py: 'ncp', lat: '39.079949', lng: '117.158642' },
    { id: 107, name: '迎风道', pinyin: 'yingfengdao', py: 'yfd', lat: '39.08632', lng: '117.14949' },
    { id: 108, name: '一中心医院', pinyin: 'yizhongxinyiyuan', py: 'yzxyy', lat: '39.103473', lng: '117.14949' },
    { id: 109, name: '天拖', pinyin: 'tiantuo', py: 'tt', lat: '39.109801', lng: '117.14949' },
    { id: 110, name: '鞍山西道', pinyin: 'anshanxidao', py: 'asxd', lat: '39.11666', lng: '117.149404' },
    { id: 111, name: '宜宾道', pinyin: 'yibindao', py: 'ybd', lat: '39.126781', lng: '117.149318' },
    { id: 112, name: '人民医院', pinyin: 'renminyiyuan', py: 'rmyy', lat: '39.146521', lng: '117.149576' },
    { id: 113, name: '复兴路', pinyin: 'fuxinglu', py: 'fxl', lat: '39.155773', lng: '117.158433' },
    { id: 114, name: '北竹林', pinyin: 'beizhulin', py: 'bzl', lat: '39.160165', lng: '117.172664' },
    { id: 115, name: '天泰路', pinyin: 'tiantailu', py: 'ttl', lat: '39.168217', lng: '117.183253' },
    { id: 116, name: '外院附中', pinyin: 'waiyuanfuzhong', py: 'wyfz', lat: '39.171295', lng: '117.191815' },
    { id: 117, name: '新开河', pinyin: 'xinkaihe', py: 'xkh', lat: '39.168883', lng: '117.202834' },
    { id: 118, name: '北宁公园', pinyin: 'beininggongyuan', py: 'bngy', lat: '39.166354', lng: '117.224484' },
    { id: 119, name: '民权门', pinyin: 'minquanmen', py: 'mqm', lat: '39.168675', lng: '117.233475' },
    { id: 120, name: '徐庄子', pinyin: 'xuzhuangzi', py: 'xzz', lat: '39.190922', lng: '117.25415' },
    { id: 121, name: '金钟街', pinyin: 'jinzhongjie', py: 'jzj', lat: '39.200026', lng: '117.266756' },
    { id: 122, name: '大毕庄', pinyin: 'dabizhuang', py: 'dbz', lat: '39.203011', lng: '117.27903' },
    { id: 123, name: '南何庄', pinyin: 'nanhezhuang', py: 'nhz', lat: '39.20637', lng: '117.290992' },
    { id: 124, name: '南孙庄', pinyin: 'nansunzhuang', py: 'nsz', lat: '39.206561', lng: '117.318265' },
    { id: 125, name: '大王庄', pinyin: 'dawangzhuang', py: 'dwz', lat: '39.128729', lng: '117.216994' },
    { id: 126, name: '十一经路', pinyin: 'shiyijinglu', py: 'syjl', lat: '39.12118', lng: '117.224109' },
    { id: 127, name: '东兴路', pinyin: 'dongxinglu', py: 'dxl', lat: '39.103856', lng: '117.242335' },
    { id: 128, name: '中山门', pinyin: 'zhongshanmen', py: 'zsm', lat: '39.100959', lng: '117.264222' },
    { id: 129, name: '一号桥', pinyin: 'yihaoqiao', py: 'yhq', lat: '39.096096', lng: '117.282731' },
    { id: 130, name: '二号桥', pinyin: 'erhaoqiao', py: 'ehq', lat: '39.09513', lng: '117.293448' },
    { id: 131, name: '张贵庄', pinyin: 'zhangguizhuang', py: 'zgz', lat: '39.092049', lng: '117.30791' },
    { id: 132, name: '新立', pinyin: 'xinli', py: 'xl', lat: '39.085937', lng: '117.335935' },
    { id: 133, name: '东丽开发区', pinyin: 'donglikaifaqu', py: 'dlkfq', lat: '39.079441', lng: '117.357198' },
    { id: 134, name: '小东庄', pinyin: 'xiaodongzhuang', py: 'xdz', lat: '39.064415', lng: '117.403204' },
    { id: 135, name: '军粮城', pinyin: 'junliangcheng', py: 'jlc', lat: '39.048102', lng: '117.455711' },
    { id: 136, name: '钢管公司', pinyin: 'gangguangongsi', py: 'gggs', lat: '39.03978', lng: '117.503805' },
    { id: 137, name: '胡家园', pinyin: 'hujiayuan', py: 'hjy', lat: '39.040686', lng: '117.60703' },
    { id: 138, name: '塘沽', pinyin: 'tanggu', py: 'tg', lat: '39.029527', lng: '117.661212' },
    { id: 139, name: '泰达', pinyin: 'teda', py: 'td', lat: '39.025493', lng: '117.679537' },
    { id: 140, name: '市民广场', pinyin: 'shiminguangchang', py: 'smgc', lat: '39.018242', lng: '117.703076' },
    { id: 141, name: '太湖路', pinyin: 'taihulu', py: 'thl', lat: '39.019834', lng: '117.723417' },
    { id: 142, name: '会展中心', pinyin: 'huizhanzhongxin', py: 'hzzx', lat: '39.029752', lng: '117.731604' },
    { id: 143, name: '东海路', pinyin: 'donghailu', py: 'dhl', lat: '39.040695', lng: '117.737323' },
    { id: 144, name: '第一大街', pinyin: 'diyidajie', py: 'dydj', lat: '39.029712', lng: '117.679828' },
    { id: 145, name: '第二大街', pinyin: 'dierdajie', py: 'dedj', lat: '39.033275', lng: '117.681082' },
    { id: 146, name: '第三大街', pinyin: 'disandajie', py: 'dsdj', lat: '39.038403', lng: '117.682749' },
    { id: 147, name: '第四大街', pinyin: 'disidajie', py: 'dsdj', lat: '39.046134', lng: '117.685496' },
    { id: 148, name: '第五大街', pinyin: 'diwudajie', py: 'dwdj', lat: '39.050642', lng: '117.687038' },
    { id: 149, name: '第六大街', pinyin: 'diliudajie', py: 'dldj', lat: '39.054605', lng: '117.688408' },
    { id: 150, name: '第七大街', pinyin: 'diqidajie', py: 'dqdj', lat: '39.058261', lng: '117.689685' },
    { id: 151, name: '第九大街', pinyin: 'dijiudajie', py: 'djdj', lat: '39.065614', lng: '117.692834' },
    { id: 152, name: '第十大街', pinyin: 'dishidajie', py: 'dsdj', lat: '39.070138', lng: '117.694771' },
    { id: 153, name: '第十一大街', pinyin: 'dishiyidajie', py: 'dsydj', lat: '39.074804', lng: '117.696739' },
    { id: 154, name: '联合研究院', pinyin: 'lianheyanjiuyuan', py: 'lhyjy', lat: '39.081956', lng: '117.702804' },
    { id: 155, name: '学院区', pinyin: 'xueyuanqu', py: 'xyq', lat: '39.084092', lng: '117.701972' },
    { id: 156, name: '学院区北', pinyin: 'xueyuanqubei', py: 'xyqb', lat: '39.088652', lng: '117.704815' }
  ]
};