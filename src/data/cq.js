export default {
  lineList: [
    ...
    { name: '5号线', color: '#00A2DB', stations: [ 98, 99, 100, 101, 102, 103, 104, 105, 106, 107 ] },
    { name: '6号线', color: '#FD67A3', stations: [ 108, 109, 110, 111, 112, 1, 113, 114, 115, 116, 117, 66, 118, 106, 105, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131 ] },
    { name: '国博线', color: '#FF88B9', stations: [ 123, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143 ] },
    { name: '10号线', color: '#7E1FC1', stations: [ 144, 116, 145, 71, 91, 146, 147, 148, 149, 150, 151, 83, 152, 153, 154, 155, 156, 136, 137 ] },
    { name: '环线', color: '#D6BD7C', stations: [ 157, 158, 159, 160, 161, 162, 105, 163, 164, 90, 71, 165, 115, 166, 167, 112, 168, 169, 60, 170, 171, 172, 173, 174, 175, 176 ] },
    { name: '4号线环线直通快线', color: '#D6BD7C', stations: [ 157, 158, 105, 90, 91, 92, 97 ] }
  ],
  stationList: [
    ...
    { id: 108, name: '茶园', pinyin: 'chayuan', py: 'cy', lat: '29.487556', lng: '106.642632' },
    { id: 109, name: '邱家湾', pinyin: 'qiujiawan', py: 'qjw', lat: '29.497919', lng: '106.649604' },
    { id: 110, name: '长生桥', pinyin: 'changshengqiao', py: 'csq', lat: '29.510992', lng: '106.65793' },
    { id: 111, name: '刘家坪', pinyin: 'liujiaping', py: 'ljp', lat: '29.524735', lng: '106.655655' },
    { id: 112, name: '上新街', pinyin: 'shangxinjie', py: 'sxj', lat: '29.556172', lng: '106.597076' },
    { id: 113, name: '大剧院', pinyin: 'dajuyuan', py: 'djy', lat: '29.569667', lng: '106.576906' },
    { id: 114, name: '江北城', pinyin: 'jiangbeicheng', py: 'jbc', lat: '29.575883', lng: '106.571962' },
    { id: 115, name: '五里店', pinyin: 'wulidian', py: 'wld', lat: '29.585193', lng: '106.565125' },
    { id: 116, name: '红土地', pinyin: 'hongtudi', py: 'htd', lat: '29.584001', lng: '106.551243' },
    { id: 117, name: '黄泥塝', pinyin: 'huangnibang', py: 'hnb', lat: '29.588524', lng: '106.538132' },
    { id: 118, name: '花卉园', pinyin: 'huahuiyuan', py: 'hhy', lat: '29.583243', lng: '106.512951' },
    { id: 119, name: '光电园', pinyin: 'guangdianyuan', py: 'gdy', lat: '29.616182', lng: '106.499454' },
    { id: 120, name: '大竹林', pinyin: 'dazhulin', py: 'dzl', lat: '29.628158', lng: '106.478275' },
    { id: 121, name: '康庄', pinyin: 'kangzhuang', py: 'kz', lat: '29.634704', lng: '106.479005' },
    { id: 122, name: '九曲河', pinyin: 'jiuquhe', py: 'jch', lat: '29.654025', lng: '106.482867' },
    { id: 123, name: '礼嘉', pinyin: 'lijia', py: 'lj', lat: '29.667263', lng: '106.488017' },
    { id: 124, name: '金山寺', pinyin: 'jinshansi', py: 'jss', lat: '29.679363', lng: '106.492094' },
    { id: 125, name: '曹家湾', pinyin: 'caojiawan', py: 'cjw', lat: '29.72104', lng: '106.494326' },
    { id: 126, name: '蔡家', pinyin: 'caijia', py: 'cj', lat: '29.73603', lng: '106.492266' },
    { id: 127, name: '向家岗', pinyin: 'xiangjiagang', py: 'xjg', lat: '29.739216', lng: '106.472954' },
    { id: 128, name: '龙凤溪', pinyin: 'longfengxi', py: 'lfx', lat: '29.789546', lng: '106.403882' },
    { id: 129, name: '状元碑', pinyin: 'zhuangyuanbei', py: 'zyb', lat: '29.803195', lng: '106.398839' },
    { id: 130, name: '西南大学', pinyin: 'xinandaxue', py: 'xndx', lat: '29.816258', lng: '106.423699' },
    { id: 131, name: '北碚', pinyin: 'beibei', py: 'bb', lat: '29.825331', lng: '106.437463' },
    { id: 132, name: '欢乐谷', pinyin: 'huanlegu', py: 'hlg', lat: '29.668995', lng: '106.508818' },
    { id: 133, name: '黄茅坪', pinyin: 'huangmaoping', py: 'hmp', lat: '29.676117', lng: '106.531606' },
    { id: 134, name: '高义口', pinyin: 'gaoyikou', py: 'gyk', lat: '29.702624', lng: '106.528044' },
    { id: 135, name: '国博中心', pinyin: 'guobozhongxin', py: 'gbzx', lat: '29.71649', lng: '106.545554' },
    { id: 136, name: '悦来', pinyin: 'yuelai', py: 'yl', lat: '29.725472', lng: '106.547914' },
    { id: 137, name: '王家庄', pinyin: 'wangjiazhuang', py: 'wjz', lat: '29.743538', lng: '106.545643' },
    { id: 138, name: '清溪河', pinyin: 'qingxihe', py: 'qxh', lat: '29.763586', lng: '106.547744' },
    { id: 139, name: '刘家院子', pinyin: 'liujiayuanzi', py: 'ljyz', lat: '29.781243', lng: '106.554138' },
    { id: 140, name: '思源', pinyin: 'siyuan', py: 'sy', lat: '29.806978', lng: '106.547615' },
    { id: 141, name: '复兴', pinyin: 'fuxing', py: 'fx', lat: '29.822542', lng: '106.548259' },
    { id: 142, name: '红岩坪', pinyin: 'hongyanping', py: 'hyp', lat: '29.831217', lng: '106.548796' },
    { id: 143, name: '沙河坝', pinyin: 'shaheba', py: 'shb', lat: '29.84231', lng: '106.557443' },
    { id: 144, name: '鲤鱼池', pinyin: 'liyuchi', py: 'lyc', lat: '29.574013', lng: '106.550154' },
    { id: 145, name: '龙头寺公园', pinyin: 'longtousigongyuan', py: 'ltsgy', lat: '29.598644', lng: '106.550562' },
    { id: 146, name: '民心佳园', pinyin: 'minxinjiayuan', py: 'mxjy', lat: '29.626645', lng: '106.567599' },
    { id: 147, name: '三亚湾', pinyin: 'sanyawan', py: 'syw', lat: '29.638348', lng: '106.584808' },
    { id: 148, name: '上湾路', pinyin: 'shangwanlu', py: 'swl', lat: '29.649836', lng: '106.608878' },
    { id: 149, name: '环山公园', pinyin: 'huanshangongyuan', py: 'hsgy', lat: '29.658905', lng: '106.622081' },
    { id: 150, name: '长河', pinyin: 'changhe', py: 'ch', lat: '29.674045', lng: '106.629419' },
    { id: 151, name: '江北机场T3航站楼', pinyin: 'jiangbeijichangt3hangzhanlou', py: 'jbjct3hzl', lat: '29.708446', lng: '106.655265' },
    { id: 152, name: '渝北广场', pinyin: 'yubeiguangchang', py: 'ybgc', lat: '29.718537', lng: '106.629795' },
    { id: 153, name: '鹿山', pinyin: 'lushan', py: 'ls', lat: '29.720587', lng: '106.608321' },
    { id: 154, name: '中央公园东', pinyin: 'zhongyanggongyuandong', py: 'zygyd', lat: '29.723694', lng: '106.593515' },
    { id: 155, name: '中央公园', pinyin: 'zhongyanggongyuan', py: 'zygy', lat: '29.72373', lng: '106.583698' },
    { id: 156, name: '中央公园西', pinyin: 'zhongyanggongyuanxi', py: 'zygyx', lat: '29.723749', lng: '106.572282' },
    { id: 157, name: '重庆图书馆', pinyin: 'chongqingtushuguan', py: 'cqtsg', lat: '29.532221', lng: '106.455463' },
    { id: 158, name: '沙坪坝(环)', pinyin: 'shapingba', py: 'spb', lat: '29.556088', lng: '106.459398' },
    { id: 159, name: '重庆大学', pinyin: 'chongqingdaxue', py: 'cqdx', lat: '29.568173', lng: '106.46307' },
    { id: 160, name: '玉带山', pinyin: 'yudaishan', py: 'yds', lat: '29.580713', lng: '106.476095' },
    { id: 161, name: '南桥寺', pinyin: 'nanqiaosi', py: 'nqs', lat: '29.590389', lng: '106.482404' },
    { id: 162, name: '体育公园', pinyin: 'tiyugongyuan', py: 'tygy', lat: '29.598822', lng: '106.4875' },
    { id: 163, name: '动步公园', pinyin: 'dongbugongyuan', py: 'dbgy', lat: '29.603151', lng: '106.504838' },
    { id: 164, name: '洪湖东路', pinyin: 'honghudonglu', py: 'hhdl', lat: '29.607647', lng: '106.512412' },
    { id: 165, name: '渝鲁', pinyin: 'yulu', py: 'yl', lat: '29.595991', lng: '106.559496' },
    { id: 166, name: '弹子石', pinyin: 'danzishi', py: 'dzs', lat: '29.585836', lng: '106.592347' },
    { id: 167, name: '涂山', pinyin: 'tushan', py: 'ts', lat: '29.575983', lng: '106.600587' },
    { id: 168, name: '海棠溪', pinyin: 'haitangxi', py: 'htx', lat: '29.534487', lng: '106.587093' },
    { id: 169, name: '罗家坝', pinyin: 'luojiaba', py: 'ljb', lat: '29.526245', lng: '106.583005' },
    { id: 170, name: '南湖', pinyin: 'nanhu', py: 'nh', lat: '29.516853', lng: '106.556237' },
    { id: 171, name: '海峡路', pinyin: 'haixialu', py: 'hxl', lat: '29.518843', lng: '106.546514' },
    { id: 172, name: '谢家湾(环)', pinyin: 'xiejiawan', py: 'xjw', lat: '29.520449', lng: '106.517696' },
    { id: 173, name: '奥体中心', pinyin: 'aotizhongxin', py: 'atzx', lat: '29.523119', lng: '106.502436' },
    { id: 174, name: '陈家坪', pinyin: 'chenjiaping', py: 'cjp', lat: '29.524128', lng: '106.489905' },
    { id: 175, name: '彩云湖', pinyin: 'caiyunhu', py: 'cyh', lat: '29.516173', lng: '106.471751' },
    { id: 176, name: '二郎', pinyin: 'erlang', py: 'el', lat: '29.505044', lng: '106.462138' }
  ]
};