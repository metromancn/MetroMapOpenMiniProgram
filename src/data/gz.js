export default {
  lineList: [
    ...
    { name: '8号线', color: '#22B6B9', stations: [ 146, 147, 148, 149, 150, 151, 152, 153, 154, 93, 155, 6, 156, 114, 157, 158, 159, 160, 24, 161, 162, 163, 46, 164, 165, 166, 167, 85 ] },
    ...
    { name: '佛山3号线', color: '#0E24A5', stations: [ 270, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 134, 281, 282, 283, 284, 285, 234, 262, 286, 287, 288 ] },
    { name: 'APM线', color: '#67CDE8', stations: [ 47, 289, 290, 291, 292, 293, 294, 295, 54 ] },
    { name: '海珠电车线', color: '#ADCC6E', stations: [ 85, 296, 297, 298, 299, 300, 301, 302, 303, 304, 47 ] },
    { name: '黄埔有轨电车1号线', color: '#FC989A', stations: [ 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320, 321, 322, 323 ] },
    { name: '南海有轨电车1号线', color: '#7BC7E9', stations: [ 324, 325, 326, 327, 328, 329, 330, 331, 332, 333, 334, 335, 336, 267, 337 ] }
  ],
  stationList: [
    ...
    { id: 255, name: '湖涌', pinyin: 'huchong', py: 'hc', lat: '23.002987', lng: '113.011373' },
    { id: 256, name: '绿岛湖', pinyin: 'lvdaohu', py: 'ldh', lat: '23.001999', lng: '113.034204' },
    { id: 257, name: '智慧新城', pinyin: 'zhihuixincheng', py: 'zhxc', lat: '23.011223', lng: '113.05534' },
    { id: 258, name: '张槎', pinyin: 'zhangcha', py: 'zc', lat: '23.011045', lng: '113.067721' },
    { id: 259, name: '石湾', pinyin: 'shiwan', py: 'sw', lat: '23.005337', lng: '113.083256' },
    { id: 260, name: '沙岗', pinyin: 'shagang', py: 'sg', lat: '22.996528', lng: '113.094242' },
    { id: 261, name: '石梁', pinyin: 'shiliang', py: 'sl', lat: '22.992696', lng: '113.118715' },
    { id: 262, name: '湾华', pinyin: 'wanhua', py: 'wh', lat: '22.991985', lng: '113.131485' },
    { id: 263, name: '登洲', pinyin: 'dengzhou', py: 'dz', lat: '22.979293', lng: '113.148777' },
    { id: 264, name: '花卉世界', pinyin: 'huahuishijie', py: 'hhsj', lat: '22.973416', lng: '113.16134' },
    { id: 265, name: '仙涌', pinyin: 'xianchong', py: 'xc', lat: '22.982997', lng: '113.198226' },
    { id: 266, name: '石洲', pinyin: 'shizhou', py: 'sz', lat: '22.990602', lng: '113.216111' },
    { id: 267, name: '林岳西', pinyin: 'linyuexi', py: 'lyx', lat: '22.993736', lng: '113.237135' },
    { id: 268, name: '林岳东', pinyin: 'linyuedong', py: 'lyd', lat: '22.993937', lng: '113.249709' },
    { id: 269, name: '广州南站(佛山2)', pinyin: 'guangzhounanzhanfoshan2', py: 'gznzfs2', lat: '22.988277', lng: '113.265842' },
    { id: 270, name: '顺德学院站', pinyin: 'shundexuexuanzhan', py: 'sdxxz', lat: '22.819294', lng: '113.31929' },
    { id: 271, name: '顺德欢乐海岸', pinyin: 'shundehuanlehaian', py: 'sdhlha', lat: '22.81882', lng: '113.307124' },
    { id: 272, name: '顺德一中', pinyin: 'shundeyizhong', py: 'sdyz', lat: '22.832881', lng: '113.293627' },
    { id: 273, name: '驹荣北路', pinyin: 'jurongbeilu', py: 'jrbl', lat: '22.834958', lng: '113.277684' },
    { id: 274, name: '东乐路', pinyin: 'donglelu', py: 'dll', lat: '22.834938', lng: '113.264702' },
    { id: 275, name: '大良钟楼', pinyin: 'daliangzhonglou', py: 'dlzl', lat: '22.838498', lng: '113.253565' },
    { id: 276, name: '环市北', pinyin: 'huanshibei', py: 'hsb', lat: '22.852483', lng: '113.244119' },
    { id: 277, name: '顺德人民医院', pinyin: 'shunderenminyiyuan', py: 'sdrmyy', lat: '22.867856', lng: '113.24238' },
    { id: 278, name: '荔村', pinyin: 'licun', py: 'lc', lat: '22.872151', lng: '113.231314' },
    { id: 279, name: '伦教', pinyin: 'lunjiao', py: 'lj', lat: '22.880395', lng: '113.214148' },
    { id: 280, name: '广教', pinyin: 'guangjiao', py: 'gj', lat: '22.909117', lng: '113.212774' },
    { id: 281, name: '高村', pinyin: 'gaocun', py: 'gc', lat: '22.944326', lng: '113.193943' },
    { id: 282, name: '北滘西站', pinyin: 'beijiaoxizhan', py: 'bjxz', lat: '22.951981', lng: '113.178185' },
    { id: 283, name: '潭洲会展', pinyin: 'tanzhouhuizhan', py: 'tzhz', lat: '22.948069', lng: '113.164087' },
    { id: 284, name: '岳步', pinyin: 'yuebu', py: 'yb', lat: '22.943148', lng: '113.144582' },
    { id: 285, name: '大墩', pinyin: 'dadun', py: 'dd', lat: '22.953917', lng: '113.129519' },
    { id: 286, name: '亚艺公园', pinyin: 'yayigongyuan', py: 'yygy', lat: '23.001922', lng: '113.129497' },
    { id: 287, name: '季华六路', pinyin: 'jihualiulu', py: 'jhll', lat: '23.01202', lng: '113.13675' },
    { id: 288, name: '镇安', pinyin: 'zhenan', py: 'za', lat: '23.017061', lng: '113.144314' },
    { id: 289, name: '海心沙', pinyin: 'haixinsha', py: 'hsx', lat: '23.111554', lng: '113.324401' },
    { id: 290, name: '大剧院', pinyin: 'dajuyuan', py: 'djy', lat: '23.115407', lng: '113.324463' },
    { id: 291, name: '花城大道', pinyin: 'huachengdadao', py: 'hcdd', lat: '23.119105', lng: '113.324704' },
    { id: 292, name: '妇儿中心', pinyin: 'fuerzhongxin', py: 'fezx', lat: '23.123227', lng: '113.324481' },
    { id: 293, name: '黄埔大道', pinyin: 'huangpudadao', py: 'hpdd', lat: '23.126996', lng: '113.324495' },
    { id: 294, name: '天河南', pinyin: 'tianhenan', py: 'thn', lat: '23.131198', lng: '113.324491' },
    { id: 295, name: '体育中心南', pinyin: 'tiyuzhongxinnan', py: 'tyzxn', lat: '23.134363', lng: '113.324303' },
    { id: 296, name: '琶洲塔', pinyin: 'pazhouta', py: 'pzt', lat: '23.099177', lng: '113.376978' },
    { id: 297, name: '琶洲大桥南', pinyin: 'pazhoudaqiaonan', py: 'pzdqn', lat: '23.10427', lng: '113.375465' },
    { id: 298, name: '会展东', pinyin: 'huizhandong', py: 'hzd', lat: '23.103934', lng: '113.368835' },
    { id: 299, name: '会展中', pinyin: 'huizhanzhong', py: 'hzz', lat: '23.104170', lng: '113.362599' },
    { id: 300, name: '会展西', pinyin: 'huizhanxi', py: 'hzx', lat: '23.104323', lng: '113.356194' },
    { id: 301, name: '南风', pinyin: 'nanfeng', py: 'nf', lat: '23.105488', lng: '113.348705' },
    { id: 302, name: '琶醍', pinyin: 'pati', py: 'pt', lat: '23.107471', lng: '113.340141' },
    { id: 303, name: '猎德大桥南', pinyin: 'liededaqiaonan', py: 'lddqn', lat: '23.107373', lng: '113.335632' },
    { id: 304, name: '广州塔东', pinyin: 'guangzhoutadong', py: 'gztd', lat: '23.107022', lng: '113.327054' },
    { id: 305, name: '新丰路', pinyin: 'xinfenglu', py: 'xfl', lat: '23.199155', lng: '113.548898' },
    { id: 306, name: '贤江', pinyin: 'xianjiang', py: 'xj', lat: '23.202074', lng: '113.541882' },
    { id: 307, name: '贤江公园', pinyin: 'xianjianggongyuan', py: 'xjgy', lat: '23.207004', lng: '113.535466' },
    { id: 308, name: '贤江西', pinyin: 'xianjiangxi', py: 'xjx', lat: '23.211806', lng: '113.528567' },
    { id: 309, name: '岭头东', pinyin: 'lingtoudong', py: 'ltd', lat: '23.215992', lng: '113.519051' },
    { id: 310, name: '干部健康中心', pinyin: 'ganbujiankangzhongxin', py: 'gbjkzx', lat: '23.21754', lng: '113.513203' },
    { id: 311, name: '岭头', pinyin: 'lingtou', py: 'lt', lat: '23.21645', lng: '113.509577' },
    { id: 312, name: '长岭居小学', pinyin: 'changlingjuxiaoxue', py: 'cljxx', lat: '23.214735', lng: '113.502024' },
    { id: 313, name: '羌洞', pinyin: 'qiangdong', py: 'qd', lat: '23.21296', lng: '113.498768' },
    { id: 314, name: '地铁长平', pinyin: 'ditiechangping', py: 'dtcp', lat: '23.211205', lng: '113.49041' },
    { id: 315, name: '北师大实验学校', pinyin: 'beishidashiyanxuexiao', py: 'bsdsyxx', lat: '23.206139', lng: '113.492338' },
    { id: 316, name: '水西(黄埔有轨)', pinyin: 'shuixi', py: 'sx', lat: '23.199577', lng: '113.484216' },
    { id: 317, name: '峻泰路', pinyin: 'juntailu', py: 'jtl', lat: '23.19115', lng: '113.485669' },
    { id: 318, name: '地铁水西', pinyin: 'ditieshuixi', py: 'dtsx', lat: '23.188184', lng: '113.481501' },
    { id: 319, name: '会议中心', pinyin: 'huiyizhongxin', py: 'hyzx', lat: '23.182474', lng: '113.474275' },
    { id: 320, name: '市民广场', pinyin: 'shiminguangchang', py: 'smgc', lat: '23.178677', lng: '113.480723' },
    { id: 321, name: '线坑', pinyin: 'xiankeng', py: 'xk', lat: '23.176912', lng: '113.488319' },
    { id: 322, name: '区少年宫（萝岗）', pinyin: 'qushaoniangong', py: 'qsng', lat: '23.176349', lng: '113.492407' },
    { id: 323, name: '地铁香雪', pinyin: 'ditiexiangxue', py: 'dtxx', lat: '23.173893', lng: '113.499703' },
    { id: 324, name: '礌岗(南海有轨)', pinyin: 'leigang', py: 'lg', lat: '23.042635', lng: '113.155414' },
    { id: 325, name: '华翠路', pinyin: 'huacuilu', py: 'hcl', lat: '23.036948', lng: '113.164206' },
    { id: 326, name: '夏西', pinyin: 'xiaxi', py: 'xx', lat: '23.035823', lng: '113.172038' },
    { id: 327, name: '夏东', pinyin: 'xiadong', py: 'xd', lat: '23.034648', lng: '113.181512' },
    { id: 328, name: '康怡公园', pinyin: 'kangyigongyuan', py: 'kygy', lat: '23.033167', lng: '113.189977' },
    { id: 329, name: '平西', pinyin: 'pingxi', py: 'px', lat: '23.028042', lng: '113.195824' },
    { id: 330, name: '平南', pinyin: 'pingnan', py: 'pn', lat: '23.020558', lng: '113.201768' },
    { id: 331, name: '玉器街', pinyin: 'yuqijie', py: 'yqj', lat: '23.021664', lng: '113.209729' },
    { id: 332, name: '中区', pinyin: 'zhongqu', py: 'zq', lat: '23.025593', lng: '113.225865' },
    { id: 333, name: '三山新城北', pinyin: 'sanshanxinchengbei', py: 'ssxcb', lat: '23.023046', lng: '113.234727' },
    { id: 334, name: '文翰湖公园', pinyin: 'wenhanhugongyuan', py: 'whhgy', lat: '23.019131', lng: '113.235821' },
    { id: 335, name: '三山新城南', pinyin: 'sanshanxinchengnan', py: 'ssxcn', lat: '23.006452', lng: '113.234254' },
    { id: 336, name: '林岳北', pinyin: 'linyuebei', py: 'lyb', lat: '23.00342', lng: '113.233637' },
    { id: 337, name: '林岳东(南海有轨)', pinyin: 'linyuedong', py: 'lyd', lat: '22.993937', lng: '113.249709' }
  ]
};